				...
				$.getJSON("getNewsList", {page: itemNum/10 + 1}, function(sqlJson){
					...
					if(itemNum>30000){
						...
						for(var i in sqlJson){
							...
							html+="<span class='sp1'><b>"+100+"</b>浏览</span>";
							html+="<span class='sp2'>"+sqlJson[i].writer+"</span><span class='sp3'>"+new Date(sqlJson[i].date).format("yyyy-MM-dd hh:mm:ss")+"&nbsp;By</span></div></li>";		
						}
						/*模拟ajax请求数据时延时800毫秒*/
